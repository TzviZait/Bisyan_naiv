...
def run_classifier_server():
    print("Starting classifier server on http://127.0.0.1:8000 ...")
    uvicorn.run("api_classifier:app", host="0.0.0.0", port=8000, reload=False)
...
if __name__ == "__main__":
    ...
    classifier_url = "http://127.0.0.1:8000/classifier-form"
